\chapter{The Consistency Problem: Supplemental Results}
...
figures~\ref{graph:4.2w},~\ref{graph:4.8w}, and~\ref{graph:4.13w}. Figures~\ref
...
\caption{\label{graph:4.5w} {Average Number of Worlds required by
the chase and hill-climbing approach for FD set 17, domain sizes 5 -
9, indefinite cell arity 4 - 6}}
\end{minipage}
\end{figure}
...
\begin{figure}
\begin{minipage}{7cm}
\centerline{\scalebox{0.5}{\includegraphics{../../CPP/Chase/all_results/w4_d3_a4_c.eps}}}
...
\begin{figure}
\begin{minipage}{7cm}
\centerline{\scalebox{0.5}{\includegraphics{../../CPP/Chase/all_results/w7_d3_a2_c.eps}}}
