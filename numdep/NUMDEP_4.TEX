...
For completeness, we now present inference rules 1-4 from \cite{gm85a}:
\begin{description}
...
\begin{figure}
\centerline{\scalebox{0.7}{\includegraphics{../../CPP/Time/data/nd_mine_bc.eps}}}
...
In the chapter we have defined a metric for NDs which we use in
...
\begin{definition}[A Weak Armstrong Relation]
\begin{rm}
