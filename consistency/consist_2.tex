...
In Algorithm~\ref{alg:cp_ndchase}, ND\_CHASE, we present an overview
...
\medskip
\begin{definition}[Good Classes of OR-databases, \cite{vn95}]\label{cp:def_good}
\begin{rm}
...
indefinite relation $r$ such that $r \weak$ N 
...
we refer to definition~\ref{def:sat-nd-indef}.
